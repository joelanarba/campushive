...
const serviceFailure = (error, res, next) => {
  const errors = {
    ...
    AVAILABILITY_OVERLAP: [409, "Weekly availability overlaps an existing window"],
    AVAILABILITY_HAS_BOOKINGS: [409, "Availability change would invalidate an ongoing or upcoming booking"],
    AVAILABILITY_CHANGED: [409, "Availability has changed or is no longer bookable"],
